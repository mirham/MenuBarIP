...
## Compatibility
This application is compatible with macOS 15.0 and above. All versions below 2.0 are compatible with macOS 14.0. Version [2.3](https://github.com/mirham/MenuBarIP/releases/download/2.3/MenuBarIP_macOS14.dmg) is the last compatible version for macOS 14.0 and will only be upgraded by request.
